...
Hooks are configured in `.gemini/settings.json` and fire automatically:
...
Hook reference documentation: `.gemini/docs/hooks-reference/`
Hook input schema documentation: `.gemini/docs/hooks-reference/hook-input-schemas.md`
